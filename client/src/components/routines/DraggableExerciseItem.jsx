      ...
      <div className="flex-grow w-full">
        ...
        <div className="space-y-2 mb-4">
          {exercise.sets.map((set, index) => (
            <div key={set.id} className="flex flex-wrap md:flex-nowrap items-center gap-3 bg-background p-2 rounded-sm border border-borderDark">
              ...
              <button onClick={() => onRemoveSet(set.id)} className="text-textMuted hover:text-error transition-colors p-1" title="Remove Set">
                <X size={16} />
              </button>
            </div>
          ))}
